<?php
    class news{
        ...
        public function insert(){
            $sql_command = $this->dbConn->prepare("insert into news values(null, :nume, :tip, :tipSport,:descriere, :data)");
        ...
        public function getNewsBySport($tipSport){
            $sql_command = $this->dbConn->prepare("SELECT * FROM news WHERE tipSport = :tipSport");
